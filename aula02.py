...
# if nota >= 8: #dois pontos para fazer um bloco de codigo 
...
# "Pesonormal","Sobrepeso" e "Obesidade".
...
#REFAZENDO TODAS AS QUESTÔES DEPOIS DE MAIS TEMPO DEDICADO
